...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({
  ...
  const handleSaveProjectFromEditor = async (
    ...
    await onSaveProject(projectData, projectBlocks);
    setIsEditorOpen(false);
    setEditingProjectId(undefined);
    showToast('Projeto Salvo', 'O projeto e seus blocos foram persistidos no Supabase.', 'success');
  };
            ...
            <>
              ...
              {activeTab === 'aparencia' && (
                <AppearanceManager
                  ...
                  initialUxVoice={settings.ux_voice}
