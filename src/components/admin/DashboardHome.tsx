...
export const DashboardHome: React.FC<DashboardHomeProps> = ({
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-300">
      ...
      <div className="p-6 md:p-8 bg-neutral-900 text-white rounded-2xl flex flex-col md:flex-row items-start md:items-center justify-between gap-6 shadow-md">
        <div className="space-y-2 max-w-xl">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/10 rounded-full text-xs font-mono text-emerald-400">
            ...
            <span>{isSupabaseConnected ? 'Conectado ao Supabase Cloud' : 'Persistência Local Ativa'}</span>
          </div>
      ...
      {/* Supabase & Reset Section */}
      <div className="p-6 bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div className="space-y-1">
          <h4 className="font-bold text-neutral-900 dark:text-white text-sm flex items-center gap-2">
            <Database className="w-4 h-4 text-emerald-600" />
            <span>Infraestrutura e Migração</span>
          </h4>
          <p className="text-xs text-neutral-500">
            Conecte ao seu projeto Supabase na nuvem ou redefina para os dados autorais iniciais de demonstração.
          </p>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="px-4 py-2 border border-neutral-300 dark:border-neutral-700 hover:bg-neutral-100 dark:hover:bg-neutral-700 rounded-lg text-xs font-semibold text-neutral-700 dark:text-neutral-300 transition-colors flex items-center gap-1.5"
            title="Restaura os dados e design tokens padrão"
          >
